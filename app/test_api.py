...
class TestApi(unittest.TestCase):
    ...
    def test_create_account(self):
        data = dict(email='hhhhhhhhhhh@gmail.com', password='0000000', firstname='hadhemi',
                    lastname='wesleti',
                    phone_number='27310836', dateOfBirth=None, adresse='tunis')
    ...
    def test_delete_user(self):
        data = dict(email='hhhhhhhhhhh@gmail.com', id=1, enabled=True)
        with  app.app_context():
            self.client = app.test_client()
    ...
    # login
    def test_login(self):
        data = dict(email='hhhhhhhhhhh@gmail.com', password='0000000')
        with  app.app_context():
            self.client = app.test_client()
    ...
    def test_add_device(self):
        data = dict(localisation='jjjf', code_device='2225', email='hhhh@gmail.com', install_at='2019-07-01',
